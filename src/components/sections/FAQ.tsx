...
const faqs = [
  ...
  {
    question: 'Cosa include esattamente il prezzo di 1.700€?',
    answer: 'Il prezzo include: alloggio in villa con piscina per 10 notti, tutti gli allenamenti, safari completo, escursioni, kayak, snorkeling, cene gourmet, aperitivi, trasferimenti locali e organizzazione completa. Praticamente tutto, tranne voli internazionali, visto e alcuni pranzi.',
  },
  {
